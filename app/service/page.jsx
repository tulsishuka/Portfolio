...
// // const Services = () => {
// //   return (
// //    <section className="min-h-[80vh] flex flex-col gap-12 justify-center py-12 xl:py-0">
...
// //               <div className="text-5xl font-extrabold text-outline text-transparent group-hover:text-outline-hover hover:text-green-400 transition-all duration-500">
// //                 {service.num}
// //               </div>
// //               <Link href="service.href"  className="w-[70px] h-[70px] bg-white hover:-rotate-45 hover:bg-green-400 border border-white/20 rounded-full flex justify-center items-center text-white/20 text-3xl hover:border-green-400 hover:text-green-400 transition-all duration-500"> 
// //               <BsArrowDownRight className="text-primary text-3xl"/>
// //               </Link>
// //             </div>
// //             <h2 className="text-[42px] font-bold leading-none text-white group-hover:text-accent hover:text-green-400 transition-all duration-500">{service.title}</h2>
// //             <p>{service.desc}</p>
...
//           className="grid grid-cols-1 md:grid-cols-2 gap-[60px] max-w-6xl"
//         >
//           {services.map((service, index) => {
//             return (
//               <div className="flex-1 flex flex-col justify-center gap-6 group" key={index}>
...
//                   <Link
//                     href="service.href"
//                     className="w-[70px] h-[70px] bg-white hover:-rotate-45 hover:bg-green-400 border border-white/20 rounded-full flex justify-center items-center text-white/20 text-3xl hover:border-green-400 hover:text-green-400 transition-all duration-500"
//                   >
//                     <BsArrowDownRight className="text-primary text-3xl" />
//                   </Link>
//                 </div>
//                 <h2 className="text-[42px] font-bold leading-none text-white group-hover:text-accent hover:text-green-400 transition-all duration-500">
//                   {service.title}
//                 </h2>
//                 <p>{service.desc}</p>
//                 <div className="border-b border-white/20 w-full"></div>
